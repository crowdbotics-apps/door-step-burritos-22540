"""door_step_burritos_22540 URL Configuration
...
admin.site.site_header = "Door Step Burritos"
admin.site.site_title = "Door Step Burritos Admin Portal"
admin.site.index_title = "Door Step Burritos Admin"

# swagger
api_info = openapi.Info(
    title="Door Step Burritos API",
    default_version="v1",
    description="API documentation for Door Step Burritos App",
)
